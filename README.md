# Kaspa Solo Mining Console — source repository

> This repository is retained as the application and package source. The
> canonical community app store has moved to
...
an exact deployment-file allowlist. Development source, tests, build files,
logs, diagnostics, and other non-runtime artifacts are not copied.
